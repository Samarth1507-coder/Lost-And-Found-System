...
$email=$_POST['email'];
 ...
 if (isset($_FILES['image']) && $_FILES['image']['error'] == 0) {
    ...
    $stmt = mysqli_prepare($conn, "INSERT INTO lostitems (itemname, location, description, ownername, phonenumber, email, image_path) VALUES (?, ?, ?, ?, ?, ?, ?)");
    mysqli_stmt_bind_param($stmt, "sssssss", $itemname, $location, $description, $ownername, $phonenumber, $email, $image_path);
